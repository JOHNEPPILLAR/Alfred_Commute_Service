...
async function _tubeStatus(req, res, next) {
  ...
  const TFLAPIKey = await this._getVaultSecret.call(this, 'TFLAPIKey');
...
async function _nextbus(req, res, next) {
  ...
  const TFLAPIKey = await this._getVaultSecret(this, 'TFLAPIKey');
...
async function _nextTrain(req, res, next) {
  ...
  const TransportAPIKey = await this._getVaultSecret('TransportAPIKey');
